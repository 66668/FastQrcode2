...
import com.google.myzxing2.oned.EANManufacturerOrgSupport_S;
import com.google.myzxing2.oned.OneDReader_S;
import com.google.myzxing2.oned.UPCEANExtensionSupport_S;
...
public abstract class UPCEANReader_S extends OneDReader_S {
   ...
   * @throws FormatException_S if the string does not contain only digits
   */
